...
def binary_array(array, thresh, value=0):
        ...
        number of rows x number of columns = number of pixels from top to bottom x number of pixels from left to right 
        """
...
def blur_gaussian(channel, ksize=3):
        ...
        :param ksize: Size of the small matrix (i.e. kernel) used to bluri.e. number of rows and number of columns
...
def threshold(channel, thresh=(128,255), thresh_type=cv2.THRESH_BINARY):
        ...
        ret: Threshold that was used thresholded_image: 2D thresholded data.
        """ 
